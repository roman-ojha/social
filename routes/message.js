...
messageRoute.post("/u/createMessage", authenticate, async (req, res) => {
  try {
...
messageRoute.post("/u/getMessage", authenticate, async (req, res) => {
  try {
    const rootUser = req.rootUser;
...
messageRoute.post("/u/sendMessage", authenticate, async (req, res) => {
