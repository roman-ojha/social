...
settingRoute.post("/changeProfile/imgUrl", authenticate, async (req, res) => {
  try {
...
settingRoute.post("/changeUserID", authenticate, async (req, res) => {
  try {
...
settingRoute.post("/changeName", authenticate, async (req, res) => {
  try {
...
settingRoute.post("/changePassword", authenticate, async (req, res) => {
  try {
